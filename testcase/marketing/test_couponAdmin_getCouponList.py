...
def test_query_coupon_approve_list( ):
    '''
    使用listType查询审批列表
    :return:
    '''
...
def test_query_coupon_list_by_pageSize_and_currentPage( ):
    '''
...
def test_query_coupon_list_useScope( ):
    '''
...
def test_query_coupon_list_status( ):
    '''
...
def test_query_coupon_list_couponName( ):
    '''
...
def test_query_coupon_list_couponName_not_exsit( ):
    '''
...
def test_query_coupon_list_couponId( ):
    '''
...
def test_query_coupon_list_couponId_not_exist( ):
    '''
    CouponEntity的couponId不存在或错误
    :return:
    '''
...
def test_query_coupon_list_CouponEntity_not_exist( ):
    '''
...
def test_query_coupon_list_CouponEntity_combine_params( ):
    '''
    CouponEntity组合查询各参数
    :return:
    '''
